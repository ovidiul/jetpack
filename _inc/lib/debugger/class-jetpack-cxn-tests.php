...
class Jetpack_Cxn_Tests extends Jetpack_Cxn_Test_Base {
	...
	protected function last__wpcom_self_test() {
		...
		if ( 200 === wp_remote_retrieve_response_code( $response ) ) {
			...
			return self::failing_test( $name, __( 'Jetpack.com detected an error.', 'jetpack' ), __( '<a href="https://jetpack.com/support/debug/">Visit the Jetpack.com debugging page</a> for more information or contact support.', 'jetpack' ) ); // @todo direct links.
		}
	}
}
